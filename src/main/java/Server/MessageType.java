...
public enum MessageType {
    ...
    ADD_PRODUCT_TO_OFF, DOES_SELLER_HAVE_OFF, DOES_SELLER_HAVE_PRODUCT, EDIT_OFF, EDIT_PRODUCT, ADD_PRODUCT, REMOVE_PRODUCT_SELLER, ADD_BALANCE, GET_CART, INCREASE_PRODUCT, DECREASE_PRODUCT, GET_CART_PRICE, ADD_RATE, GET_ALL_BUY_LOGS, DOES_CUSTOMER_HAVE_BUY_LOG, ADD_OFF, DOES_CUSTOMER_HAVE_DISCOUNT,
    ...
    GET_PAYED_FILE_PRODUCTS, GET_SOLD_FILE_PRODUCTS, LOGOUT, GET_SHOP_BALANCE, SET_WAGE, SET_MIN_BALANCE, VIEW_ONLINE_SUPPORTERS,
    SEND_MESSAGE_FROM_CUSTOMER, SENT_MESSAGE_FROM_SUPPORTER
}
