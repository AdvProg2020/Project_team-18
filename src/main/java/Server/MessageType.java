...
public enum MessageType {
    ...
    VIEW_ALL_BUY_LOGS,SEND_PURCHASE,CHARGE_WALLET,ADD_AUCTION,VIEW_ALL_AUCTIONS,BIDDING,WITHDRAW_WALLET,PERFORM_PAYMENT_WiTH_BANK_ACCOUNT,GET_PAYED_FILE_PRODUCTS,GET_SOLD_FILE_PRODUCTS
}
