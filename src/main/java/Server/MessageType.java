...
public enum MessageType {
    ...
    GET_PRODUCT_BY_ID,GET_SELL_LOG_BY_CODE,GET_BUY_LOG_BY_CODE,REGISTER,DOES_ANY_ADMIN_EXIST,EDIT_FIELD,GET_ALL_USERS,DELETE_USER,REMOVE_PRODUCT,ADD_CATEGORY,VIEW_ALL_DISCOUNT_CODES,VIEW_ALL_REQUESTS,VIEW_DISCOUNT_CODE,ADD_CUSTOMER_TO_DISCOUNT,
    ...
    DECLINE_REQUEST,EDIT_CATEGORY_BY_NAME,EDIT_CATEGORY_BY_PROPERTIES,VIEW_CATEGORY,CHAT_MESSAGE,TERMINATE
    DECLINE_REQUEST,EDIT_CATEGORY_BY_NAME,EDIT_CATEGORY_BY_PROPERTIES,VIEW_CATEGORY,CHAT_MESSAGE,CREATE_BANK_ACCOUNT,
}
